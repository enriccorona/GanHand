...
## YCB DATASET:
        if dataset_name == 'ycb_affordances':
            from data.ycb_affordances import Dataset
            dataset = Dataset(opt, mode)
        elif dataset_name == 'ycb_affordances_complete_scene':
            from data.ycb_affordances_complete_scene import Dataset
            dataset = Dataset(opt, mode)
        else:
