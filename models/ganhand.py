...
class Model(BaseModel):
    def __init__(self, opt):
       ...
       775, 777]
        ...
        # init
        self._init_losses()
        self.taxonomy_poses = np.load(opt.data_dir + '/grasp_taxonomy/average_hand_pose_taxonomy.npy')
    ...
    def _create_generator(self):
        return NetworksFactory.get_by_name('img_encoder', input_chann=4, output_dim=33) # 3-rot, 45-PCA, 3-translation

    def _create_fcnet(self):
        return NetworksFactory.get_by_name('MLP_refine', input_dim = 51+21, output_dim=51) # 51 for 3 wrist rotation, 45 PCA for joint rotation, 3 translation

    def _create_discriminator(self):
        return NetworksFactory.get_by_name('mano_discriminator', input_size=51+21+4)
