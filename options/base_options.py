...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self._parser.add_argument('--k', type=int, default=25, help='Number of clusters in K-means used to generate classes')

        self._parser.add_argument('--num_samples', type=int, default=-1, help='Number of clusters in K-means used to generate classes')
