...
def optimize_hand(handfullpose, R, T, obj_verts, step=20, delta_rot=0.0):
    print("Delta_rot is %f"%(delta_rot))
   ...
   #[ 0.18832923,  0.34337353,  0.92012321]])
    ...
    if converged:
        handfullpose_converged[0, 39:42] = limit_secondjoint_bigfinger_right*(inds[vertex_solution] + delta_rot)
    ...
    if converged:
        handfullpose_converged[0, 3:6] = limit_secondjoint_index_right*(inds[vertex_solution] + delta_rot)
    ...
    if converged:
        handfullpose_converged[0, 12:15] = limit_secondjoint_middlefinger_right*(inds[vertex_solution] + delta_rot)
    ...
    if converged:
        handfullpose_converged[0, 30:33] = limit_secondjoint_fourth_right*(inds[vertex_solution] + delta_rot)
    ...
    if converged:
        handfullpose_converged[0, 21:24] = limit_secondjoint_small_right*(inds[vertex_solution] + delta_rot)
    ...
    if converged:
        handfullpose_converged[0, 42:45] = limit_thirdjoint_bigfinger_right*(inds[vertex_solution])# + delta_rot)
    ...
    if converged:
        handfullpose_converged[0, 6:9] = limit_thirdjoint_index_right*(inds[vertex_solution])# + delta_rot)
    ...
    if converged:
        handfullpose_converged[0, 15:18] = limit_thirdjoint_middlefinger_right*(inds[vertex_solution])# + delta_rot)
    ...
    if converged:
        handfullpose_converged[0, 33:36] = limit_thirdjoint_fourth_right*(inds[vertex_solution])# + delta_rot)
    ...
    if converged:
        handfullpose_converged[0, 24:27] = limit_thirdjoint_small_right*(inds[vertex_solution])# + delta_rot)
